...
class SaveProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (!isEmpty.isEmpty(nextProps.profile)) {
      ...
      //https://stackoverflow.com/questions/54780682/return-one-or-two-objects-with-getderivedstatefromprops
      //profile.twitter = !isEmpty.isEmpty(nextProps.profile.result.social.twitter)
      profile.twitter = !isEmpty.isEmpty(nextProps.profile.social.twitter)
        ? nextProps.profile.result.social.twitter
        : '';
      profile.facebook = !isEmpty.isEmpty(nextProps.profile.social.facebook)
        ? nextProps.profile.result.social.facebook
        : "";
      profile.youtube = !isEmpty.isEmpty(nextProps.profile.social.youtube)
        ? nextProps.profile.result.social.youtube
        : "";
      profile.linkedin = !isEmpty.isEmpty(nextProps.profile.social.linkedin)
        ? nextProps.profile.result.social.linkedin
        : "";
      profile.instagram = !isEmpty.isEmpty(nextProps.profile.social.instagram)
